 ...
 * @author hwyz_leo
 */
@FeignClient(contextId = "carLineService", value = ServiceNameConstants.EDD_MDM, path = "/api/service/carLine/v1", fallbackFactory = CarLineServiceFallbackFactory.class)
