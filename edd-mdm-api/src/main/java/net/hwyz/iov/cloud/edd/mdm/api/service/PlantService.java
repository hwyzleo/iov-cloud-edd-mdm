 ...
 * @author hwyz_leo
 */
@FeignClient(contextId = "plantService", value = ServiceNameConstants.EDD_MDM, path = "/api/service/mdm/org/v1/plant", fallbackFactory = PlantServiceFallbackFactory.class)
