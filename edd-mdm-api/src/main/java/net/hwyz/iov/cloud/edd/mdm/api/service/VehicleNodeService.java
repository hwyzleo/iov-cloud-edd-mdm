 ...
 * @author hwyz_leo
 */
@FeignClient(contextId = "vehicleNodeService", value = ServiceNameConstants.EDD_MDM, path = "/api/service/vehicleNode/v1", fallbackFactory = VehicleNodeServiceFallbackFactory.class)
