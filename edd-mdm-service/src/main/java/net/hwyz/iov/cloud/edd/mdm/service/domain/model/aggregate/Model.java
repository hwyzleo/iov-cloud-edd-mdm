...
public class Model {
    ...
    public static Model create(String code, String name, String nameLocal, String carLineCode,
        ...
        Model model = Model.builder()
                ...
                .modelYear(modelYear).description(description)
                ...
                .version(1).status(ModelStatus.ACTIVE)
                .createBy(createBy).createTime(new Date())
                .modifyBy(createBy).modifyTime(new Date())
                .rowVersion(0).rowValid(true)
                .build();
        model.validateEffectiveDate();
        return model;
    }

    public void update(String name, String nameLocal, String modelYear, String description,
    ...
    public static Model createFromUpstream(String code, String name, String nameLocal, String carLineCode,
                                           String platformCode, String modelYear, String description,
    ...
    public void updateFromUpstream(String name, String nameLocal, String modelYear, String description,
                                   Date effectiveFrom, Date effectiveTo,
                                   String sourceSystem, String sourceId, String sourceVersion,
    ...
    public void deactivate(String modifyBy) {
        if (this.status != ModelStatus.ACTIVE) {
            throw new IllegalStateException("只有ACTIVE状态的车型才能失效");
        }
    ...
    public void delete(String modifyBy) {
        if (this.status != ModelStatus.DRAFT) {
            throw new IllegalStateException("只有DRAFT状态的车型才能删除");
        }
        this.rowValid = false;
        this.modifyBy = modifyBy;
        this.modifyTime = new Date();
