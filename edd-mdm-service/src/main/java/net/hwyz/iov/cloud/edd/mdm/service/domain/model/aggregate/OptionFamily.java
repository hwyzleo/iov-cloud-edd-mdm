...
public class OptionFamily {
     ...
     * 状态
     */
    private OptionFamilyStatus status;
    ...
    public static OptionFamily create(String code, String name, String nameLocal, String description,
        ...
        OptionFamily optionFamily = OptionFamily.builder()
                ...
                .rowValid(true)
                .build();
        optionFamily.validateEffectiveDate();
        return optionFamily;
    }
    ...
    public static OptionFamily createFromUpstream(String code, String name, String nameLocal, String description,
        ...
        OptionFamily optionFamily = OptionFamily.builder()
                ...
                .version(1).status(OptionFamilyStatus.ACTIVE)
    ...
    public void deactivate(String modifyBy) {
        if (this.status != OptionFamilyStatus.ACTIVE) {
            throw new IllegalStateException("只有ACTIVE状态的选项族才能失效");
        }
        this.status = OptionFamilyStatus.INACTIVE;
