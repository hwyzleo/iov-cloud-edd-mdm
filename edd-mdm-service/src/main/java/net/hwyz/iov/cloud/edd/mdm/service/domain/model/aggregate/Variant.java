...
public class Variant {
    ...
    public static Variant create(String code, String name, String nameLocal, String modelCode,
                                 String description, Date effectiveFrom, Date effectiveTo, String createBy) {
        Variant variant = Variant.builder()
                .code(code).name(name).nameLocal(nameLocal).modelCode(modelCode).description(description)
    ...
    public static Variant createFromUpstream(String code, String name, String nameLocal, String modelCode,
    ...
    public void deactivate(String modifyBy) {
        if (this.status != VariantStatus.ACTIVE) {
            throw new IllegalStateException("只有ACTIVE状态的版本才能失效");
        }
    ...
    public void delete(String modifyBy) {
        if (this.status != VariantStatus.DRAFT) {
            throw new IllegalStateException("只有DRAFT状态的版本才能删除");
        }
        this.rowValid = false;
        this.modifyBy = modifyBy;
        this.modifyTime = new Date();
